...
To get started, https://devspaces.{{ ROUTE_SUBDOMAIN }}#https://github.com/learn-quarkus/[access the Red Hat OpenShift Dev Spaces instance^] and select *Log in with OpenShift* button:
