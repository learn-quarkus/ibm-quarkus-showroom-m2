...
Using project "devspaces-kube-admin-qyf6iq".
...
Now that your app is deployed to OpenShift you can also see it in the {CONSOLE_URL}[OpenShift Console^]. Login with `{USER_ID}/{OPENSHIFT_USER_PASSWORD}`
